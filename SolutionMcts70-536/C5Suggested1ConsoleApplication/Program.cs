...
namespace C5Suggested1ConsoleApplication
{
    class Program
    {
        ...
        //Deserializações em SOAP precisam ter todos as propriedades, já em BIN não
        //Caso uma propriedade tenha sido criada colocar o atributo [OptionalField]
        ...
        static void Main(string[] args)
        {
            ...
            //Car bmw = (Car)DeserializeSoap();

            //Airplane air = (Airplane)DeserializeXML(typeof(Airplane));
            //Airplane air = (Airplane)DeserializeSoap();                       

            //Console.WriteLine("Car model {0}, manufacturer {1}, color {2}, at speed {3}", air.Model, air.Manufacturer, air.Color, air.Speed);
            //Console.WriteLine("Car model {0}, manufacturer {1}, color {2}, at speed {3}", bmw.Model, bmw.Manufacturer, bmw.Color, bmw.Speed);
